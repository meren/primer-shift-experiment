...
# reverse and forward primers for V4
reverse_primer = re.compile('ATTAGA[A,T]ACCC..GTAGTCC') 
forward_primer = re.compile('CCAGCAGC[C,T]GCGGTAA.')
...
def main(config, visualize_quality_curves = False):    
    ...
    missing_primer_R1 = u.FastQOutput(GetFilePath('MISSING_V4_PRIMER_R1.fastq'))
    missing_primer_R2 = u.FastQOutput(GetFilePath('MISSING_V4_PRIMER_R2.fastq'))
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Dealing with V4 perfect overlaps')
